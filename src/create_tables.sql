...
create table vehicles ( 
	vehicle_pk serial, asset_fk int
);
...
create table roles ( role_pk serial, title varchar(16));
create table user_is ( user_fk int, role_fk int);
create table user_supports ( user_ft int, facility_fk int);
